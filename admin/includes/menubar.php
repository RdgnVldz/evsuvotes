...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="rank.php"><i class="fa fa-trophy"></i> <span>Rank</span></a></li>
      ...
      <li class=""><a href="archived_votes.php"><i class="fa fa-file-text"></i> <span>Archived Votes</span></a></li>
